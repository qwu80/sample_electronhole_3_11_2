    ...
    display(){
        ...
        if (this.color == 0 && sceneCount !=3){
            ...
            if (this.origin.x == 0 && this.origin.y == 0 ) {
                    ...
                    //yellow
                    ellipse(this.position.x,(-array_band_depletion1[99]+array_band_hardcode[99]+72-array_band_hardcode[99]-this.botz*this.botz*(8.8)*0.2)*s_y,5)

                  
                    this.position2.y=(-array_band_depletion1[99]+array_band_hardcode[99]+72-array_band_hardcode[99]-this.botz*this.botz*(8.8)*0.2)*s_y
